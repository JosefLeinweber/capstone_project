    ...
    "Provider & Consumer Thread | start threads, send audio, and receive audio")
{
    ...
    std::cout << "providerThread.m_outputRingBuffer.m_buffer\n";
    printBuffer(providerThread.m_outputRingBuffer.m_buffer);
    std::cout << "consumerThread.m_inputRingBuffer.m_buffer\n";
    printBuffer(consumerThread.m_inputRingBuffer.m_buffer);
